...
EndlessScroll = (function() {
  ...
  EndlessScroll.prototype.wrapContainer = function() {
    if (this.innerWrap.length === 0) {
      return (this.innerWrap = $(this.target)
  ...
  EndlessScroll.prototype.isScrollableOrNot = function() {
    if (this.target === document || this.target === window) {
      return (this.isScrollable =
        ...
        $(window).scrollTop() + this.options.bottomPixels);
    } else {
      this.wrapContainer();
      return (this.isScrollable =
        this.innerWrap.length > 0 &&
        this.innerWrap.height() - $(this.target).height() <=
          $(this.target).scrollTop() + this.options.bottomPixels);
    }
  };
  ...
  EndlessScroll.prototype.shouldBeFiring = function() {
    ...
    return (
      this.isScrollable &&
      (this.options.fireOnce === false ||
        (this.options.fireOnce === true && this.fired !== true))
    );
  };
  ...
  EndlessScroll.prototype.insertLoader = function() {
    return $(this.options.insertAfter).after(
      '<div class="endless_scroll_loader_' +
        this.targetId +
  ...
  EndlessScroll.prototype.hasContent = function() {
    if (typeof this.options.content === "function") {
      this.content = this.options.content.apply(this.target, [
        this.fireSequence
      ]);
    } else {
  ...
  EndlessScroll.prototype.showContent = function() {
    $(this.options.insertAfter).after(
      '<div id="endless_scroll_content">' + this.content + "</div>"
    );
    return $("#endless_scroll_content")
      .hide()
      .fadeIn(250, function() {
  ...
  EndlessScroll.prototype.delayFireingWhenNecessary = function() {
    ...
    if (this.options.fireDelay > 0) {
      ...
      return $("#endless_scroll_marker").fadeTo(
        this.options.fireDelay,
        1,
        function() {
